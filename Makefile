...
FT_COMPILED =       ft_printf.o  types.o process_flags.o ft_atoi.o ft_frontstrtrim.o process_precision.o pr_fl2.o pr_fl3.o\
...
$(NAME): $(COMPILED)
	@ar rc $(NAME) libft.h ft_printf.h $(COMPILED) 
	@ranlib $(NAME)
	@echo "made" $(NAME)
